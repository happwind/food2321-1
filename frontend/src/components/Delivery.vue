<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-actions>
            ...
            <v-dialog v-model="pickFoodDiagram" width="500">
                <PickFoodCommand
                        @closeDialog="closePickFood"
                        @pickFood="pickFood"
                ></PickFoodCommand>
            </v-dialog>
        </v-card-actions>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async pickFood(params) {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['pickfood'].href), params)
            ...
            openPickFood() {
                this.pickFoodDiagram = true;
            },
            closePickFood() {
                this.pickFoodDiagram = false;
            },
        },
    }
</script>
